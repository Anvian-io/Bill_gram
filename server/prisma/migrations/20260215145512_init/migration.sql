/*
  ...
  - You are about to alter the column `mQty` on the `purchase_invoice_items` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Float`.
...
INSERT INTO "new_purchase_invoice_items" ("aQty", "batchId", "created_at", "fQty", "finalAmount", "id", "mQty", "productId", "purchaseInvoiceId", "rate", "schAmount", "schPercent", "taxAmount", "taxRate", "totalAmount", "updated_at") SELECT "aQty", "batchId", "created_at", "fQty", "finalAmount", "id", "mQty", "productId", "purchaseInvoiceId", "rate", "schAmount", "schPercent", "taxAmount", "taxRate", "totalAmount", "updated_at" FROM "purchase_invoice_items";
...
INSERT INTO "new_sales_invoice_items" ("aQty", "batchId", "created_at", "fQty", "finalAmount", "id", "mQty", "productId", "rate", "salesInvoiceId", "schAmount", "schPercent", "taxAmount", "taxRate", "totalAmount", "updated_at") SELECT "aQty", "batchId", "created_at", "fQty", "finalAmount", "id", "mQty", "productId", "rate", "salesInvoiceId", "schAmount", "schPercent", "taxAmount", "taxRate", "totalAmount", "updated_at" FROM "sales_invoice_items";
